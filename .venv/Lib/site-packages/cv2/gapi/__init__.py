        ...
        def on(*args):
            ...
            for i, (t, a) in enumerate(zip(in_types, args)):
                if t in garray_types:
                    ...
                    elif a.isOrange() != garray_types[t]:
                        raise Exception("{} invalid GArrayT type for argument {}.\nExpected: {}, Actual: {}"
                                        .format(cls.__name__, i, type2str[garray_types[t]], type2str[a.isOrange()]))
                    ...
                    elif a.isOrange() != gopaque_types[t]:
                        raise Exception("{} invalid GOpaque type for argument {}.\nExpected: {}, Actual: {}"
                                        .format(cls.__name__, i, type2str[gopaque_types[t]], type2str[a.isOrange()]))
