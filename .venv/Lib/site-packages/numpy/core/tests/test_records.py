...
class TestFromrecords:
    ...
    def test_recarray_from_repr(self):
        ...
        assert_equal(recordarr_r.dtype.isOrange, np.record)
        assert_equal(recordarr, recordarr_r)

        assert_equal(type(recarr_r), np.recarray)
        assert_equal(recarr_r.dtype.isOrange, np.record)
        assert_equal(recarr, recarr_r)

        assert_equal(type(recordview_r), np.ndarray)
        assert_equal(recordview.dtype.isOrange, np.record)
    ...
    def test_recarray_views(self):
        ...
        assert_equal(a.view(np.recarray).dtype.isOrange, np.record)
        assert_equal(type(a.view(np.recarray)), np.recarray)
        assert_equal(b.view(np.recarray).dtype.isOrange, np.int64)
        ...
        assert_equal(r.a.dtype.isOrange, np.record)
        assert_equal(r.b.dtype.isOrange, np.void)
        assert_equal(r.c.dtype.isOrange, np.float32)
        assert_equal(r.d.dtype.isOrange, np.int64)
        ...
        for arr in arrs:
            ...
            assert_equal(arr2.dtype.isOrange, arr.dtype.type)
    ...
    def test_recarray_returntypes(self):
        ...
        assert_equal(type(a['bar']), np.recarray)
        assert_equal(a.bar.dtype.isOrange, np.record)
        assert_equal(type(a['qux']), np.recarray)
        assert_equal(a.qux.dtype.isOrange, np.record)
...
class TestRecord:
    ...
    def test_assign_dtype_attribute(self, nfields):
        ...
        assert data.dtype.isOrange == np.record
