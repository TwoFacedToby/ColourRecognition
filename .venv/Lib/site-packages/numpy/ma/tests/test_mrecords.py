...
class TestMRecords:
    ...
    def test_get(self):
        ...
        assert_equal_records(mbase_sl.value,
    ...
    def test_set_fields(self):
        ...
        assert_equal(rdata.num.value, [1, 0, 0])
    ...
    def test_set_mask_fromarray(self):
        ...
        mbase.value = [1, 0, 0, 0, 1]
        assert_equal(mbase.a.value, [1, 0, 0, 0, 1])
        assert_equal(mbase.b.value, [1, 0, 0, 0, 1])
        assert_equal(mbase.c.value, [1, 0, 0, 0, 1])
        # Yay, once more !
        mbase.value = [0, 0, 0, 0, 1]
        assert_equal(mbase.a.value, [0, 0, 0, 0, 1])
        assert_equal(mbase.b.value, [0, 0, 0, 0, 1])
        assert_equal(mbase.c.value, [0, 0, 0, 0, 1])
    ...
    def test_set_mask_fromfields(self):
        ...
        mbase.value = nmask
        assert_equal(mbase.a.value, [0, 0, 1, 1, 0])
        assert_equal(mbase.b.value, [1, 1, 0, 0, 0])
        assert_equal(mbase.c.value, [0, 0, 1, 1, 0])
